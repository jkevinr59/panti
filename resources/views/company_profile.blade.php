...
<head>
    ...
    <![endif]-->
    <title>RPA ANUGERAH BOYOLALI</title>
            ...
            <div class="col-12">
                ...
                <nav class="navbar navbar-dark bg-dark navbar-expand-lg" role="navigation" >
                    <div class="navbar-header ml-2">
                         ...
                         <!--/.navbar-header-->
                        <a href="#" class="navbar-brand scroll-top logo "><b>RUMAH PEDULI ANAK ANUGERAH</b></a>
                    </div>
                    ...
                    <div class="form-inline">
                        ...
                        <a href="{{route('home')}}" class="btn btn-primary">Login <i class="fa fa-power-off"></i></a>
                    </div>
                    <!--/.navbar-collapse-->
                </nav>
            </div>
